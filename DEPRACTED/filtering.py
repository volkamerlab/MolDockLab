...
def find_MCS(df_scores, df_IC50, activity_threshold, sort_order):
    ...
    merged_df[['score', 'Activity']] = merged_df[[
        'score', 'Activity']].apply(pd.to_numeric)
    ...
    PandasTools.WriteSDF(
        cutoff_data,
        f'data/A/cutoff20.sdf',
        idName='HIPS code',
        molColName='ROMol',
        properties=cutoff_data.columns)
...
def write_mcs_file(df, mcs, data_name):
    ...
    IC50_df = df[df['ROMol'].apply(has_scaffold)][[
