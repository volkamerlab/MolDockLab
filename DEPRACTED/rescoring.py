    ...
    for docking_method in docking_methods:
        ...
        for scoring_method in scoring_methods:
            ...
            if scoring_method == "oddt":
                ...
                rescoring_cmd = f"oddt_cli {docked_library} --receptor data/{snapshot_ID}/protein_protoss_noligand.mol2 --score rfscore_v1_pdbbind2016 --score rfscore_v2_pdbbind2016 --score rfscore_v3_pdbbind2016 -O {rescoring_results_path}"
