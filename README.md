...
The workflow integrates 5 **docking tools**, 15 **scoring functions**, and 3 **consensus ranking methods** to select the best balanced consensus SBVS for an experimentally-validated dataset. 
