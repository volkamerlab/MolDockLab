...
def _minimize_and_select_most_stable(
    row: pd.Series, numConfs: int = 10
) -> pd.DataFrame:
    """
...
def run_gypsumdl(
    ligand_library: Path, prepared_library_path: Path, id_column: str = "ID"
) -> Path:
    """
